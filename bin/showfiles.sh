...
{
	case "$1" in
		 *hard_version* | *cwmp_rebootsave* | *reboot_info* | *main_version* | *board_type* | *optic_par_debug*  | *flashtestresult* | *equip_aging_temperature* | *panicinfo* | *result_mbist* | *keyreleasecount.txt*)  cat $1;;
...
DealWithProcFile()
{
	case "$1" in
		...
		*vmstat* | *zoneinfo* | *wap_* | *panic* | *log*) cat $1;;
		* ) echo "ERROR::The directory or file is wrong!"; return 1;;
	esac
...
{
	case "$1" in
		*dhcpd* | *dnsmasq* | *hosts* | *wan* | *dnsv6* | *osgi* | *felix* ) cat $1;;
		* ) echo "ERROR::The directory or file is wrong!"; return 1;;
	esac
