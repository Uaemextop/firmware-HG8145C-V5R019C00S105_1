...
function ControlPriority()
{
	...
	if (PriorityPolicy.toUpperCase() == "DSCPTOPBIT"  && GetCurrentWan().EnableVlan.toString().toUpperCase() == "1")
    {
        setDisplay("DefaultVlanPriorityRow", 1);
...
{
    var Disable = ((true == IsLanUpport()) || IsAdminUser())==true ? 0 : 1;
...
function ControlBJUNICONLanUpport()
{
   if ((true == IsLanUpport())
		&&(GetCfgMode().BJUNICOM == "1"))
	{
		setDisable("UserName",0);
		setDisable("Password",0);
		setDisable("ButtonApply",0);
