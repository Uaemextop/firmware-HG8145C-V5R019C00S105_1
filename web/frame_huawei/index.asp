...
if ('PTVDF2' != CfgMode.toUpperCase())
{
	if((curUserType == sysUserType && !parseInt(ConfigFlag.split("#")[0], 10)))
	{
...
function loadframe()
{
	...
	{
		if (parseInt(mngtpccwtype, 10) == 1 || (parseInt(mngttype, 10) == 1 && curUserType != sysUserType))
		{
...
function goToGuidePage()
{
	...
	if (curUserType == sysUserType && (1 == smartlanfeature))
	{
		window.location="/CustomApp/adminguideframe.asp";
	}
