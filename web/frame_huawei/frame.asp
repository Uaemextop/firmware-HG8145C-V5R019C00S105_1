...
var Frame = {
	...
	setCopyRightInfo : function(language) {
		if (language == "english") {
			$("#footerText").html("Copyright © Huawei Technologies Co., Ltd. 2010-2020. All rights reserved. ");
		}else if (language == "portuguese") {
			$("#footerText").html("Copyright © Huawei Technologies Co., Ltd. 2010-2020. Todos os direitos reservados. ");
		}else if (language == "japanese") {
			$("#footerText").html("Copyright © Huawei Technologies Co., Ltd. 2010-2020. All rights reserved. ");
		}else if (language == "spanish") {
			$("#footerText").html("Copyright © Huawei Technologies Co., Ltd. 2010-2020. Todos los derechos reservados. ");
		}else if (language == "russian") {
            $("#footerText").html("Copyright © Huawei Technologies Co., Ltd. 2010-2020. Все права защищены. ");
        }
	},
